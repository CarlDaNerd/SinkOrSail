// ── entities/Player.js ──
// The player ship. Tier-driven now: starts at Sloop (tier 2), stats stamped from
// ShipTiers. fire is per-side {port, star, bow, stern}; AI ships use a single num.
const Player = {
  create(x, y){
    const startTier = (typeof STARTER_TIER !== 'undefined') ? STARTER_TIER : 2;
    const p = {
      x, y, heading:180, vel:0, sailState:2, tier:startTier,
      hull:100, maxHull:100, ammo:48, maxAmmo:48, gold:0,
